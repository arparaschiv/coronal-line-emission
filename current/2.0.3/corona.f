...
C
      ...
      ELSE IF(CORNAM(1:6) .EQ. 'DIPOLV') THEN 
         IPRINT=1
         CALL DIPOLV(RB,TB,PB,BS,TS,PS,PNE,TOTH,PT,PVEL,PTURBV,IPRINT)
      ...
      ELSE IF(CORNAM(1:5) .EQ. 'CUSER') THEN 
       ...
       ELSE IF(CORNAM(1:5) .EQ. 'SHEETX') THEN 
         IPRINT=1
         CALL SHEETX(RB,TB,PB,BS,TS,PS,PNE,TOTH,PT,PVEL,PTURBV,IPRINT)
      ELSE 
