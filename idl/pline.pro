; $Id: pline.pro,v 1.15.4.1 1999/01/16 16:46:23 scottm Exp $
;
; Copyright (c) 1983-1999, Research Systems, Inc.  All rights reserved.
;	Unauthorized reproduction prohibited.

PRO PLINE,U,V,X,Y, Missing = Missing, Length = length, Dots = dots,  $
...
;
; PURPOSE:
;	Produce a two-dimensional velocity field plot without arrow.
;
;	A line is drawn at each point showing the unsigned direction and 
...
;
;       OVERPLOT: Set this keyword to make PLINE "overplot".  That is, the
...
;
        ...
        IF(n_elements(nohead) NE 0) THEN r = 0.
...
;PGJ added
;                plots,(x0+x1)/2,(y0+y1)/2,color = color,psym = 8
;                plots,x0,y0,color = color,psym = 8
                endfor
